...
這篇的根據，是採用「[客製的設定](https://github.com/samwhelp/kde-neon-adjustment/tree/main/prototype/main/kde-config/locale/en_us/Breeze-Dark)」，

請參考「我的設定檔: [~/.config/kglobalshortcutsrc](https://github.com/samwhelp/kde-neon-adjustment/blob/main/prototype/main/kde-config/locale/en_us/Breeze-Dark/asset/overlay/etc/skel/.config/kglobalshortcutsrc)」。
